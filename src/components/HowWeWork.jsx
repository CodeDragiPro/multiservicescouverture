...
const HowWeWork = () => {
  ...
  return (
    <div className="bg-custom-gradient p-4">
      <h1 className='text-2xl font-bold uppercase mb-8 text-white text-center'>Ce que nous proposons</h1>
      <div className="flex items-center justify-center">
      <ol className="relative text-gray-500 border-s border-gray-200 m-4">
        <li className="mb-10 ms-6">
          <span className="absolute flex items-center justify-center w-8 h-8 bg-teal-700 rounded-full -start-4 ring-2 ring-white">
        ...
        <li className="ms-6">
          <span className="absolute flex items-center justify-center w-8 h-8 bg-teal-700 rounded-full -start-4 bottom-0 ring-2 ring-white">
